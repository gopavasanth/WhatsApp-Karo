class Countries {
  static String getFlagEmoji(String countryCode) {
    const flagOffset = 127397; // Offset to flag emojis in Unicode

    final countryCodeUppercase = countryCode.toUpperCase();
    final codePoints = countryCodeUppercase.runes.map((e) => e + flagOffset);
    final flagEmoji = String.fromCharCodes(codePoints);
